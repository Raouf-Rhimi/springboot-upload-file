...
import bridge.nosql.workshop.service.impl.UserService;
...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestParam String username, @RequestParam String email) {
